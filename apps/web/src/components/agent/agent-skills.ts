...
export const INTENT_SKILL_MAP: Record<string, string> = {
  ...
  architecture_overview: "dimensions",
  security_overview: "dimensions",
  reliability_overview: "dimensions",
  performance_overview: "dimensions",
  database_overview: "dimensions",
  database_gaps: "gaps",
